...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Mend CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Mend controllers
...
# This target prepares repo for your provider by replacing all "mend"
